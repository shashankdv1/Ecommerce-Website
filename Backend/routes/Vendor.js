...
const upload = multer();
const{handleRegistration, handleLogin, WarehouseCode,warehouseDetails,RequestManagement,handlePriorities, DisplayRequests}=require('../controllers/Vendor');
...
vendorRouter.post("/DisplayRequests",DisplayRequests);
